...
/**
 * Queues are FIFO - first in, first out, like a checkout line. They are 
 * used in algorithms where it is needed to keep
 ...
 * 3 |   |  
 *
 * ArrayDeque fills the role of *both* queues and stacks. You could think of 
 * a Deque as a deck of cards (pronounced the
 * same) where you could remove cards  from either the top or bottom. You can
 *  use ArrayDeque
 ...
 * functionality
 * to handle multiple 'priorities' of items. You can read about PriorityQueue 
 * here:
 * https://www.geeksforgeeks.org/priority-queue-class-in-java/
 */
public class Lab {
    /**
     * Instantiate and return some type of Deque, which is a class that 
     * contains Queue and Stack functionality.
     * @return an instantiated Deque. Queue, by itself, doesn't have a class,
     * so you should use a class that
     * implements the Queue interface, such as ArrayDeque. Deques contain all 
     * the methods required for both Queue and
     * Stack behavior.
     */
